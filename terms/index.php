<html>
	...
	<body>
		...
		<div id="main">
			...
			<h2>Account</h2>
			<p>You can create and sign in to a GradeFear account using the <a href="../login" class="blue">login<a> page. You can request to <a href="../dashboard" class="blue">delete</a> your account at any time, which will be done immediately upon your request.</p>
			<p>You are responsible of all actions done using your GradeFear Account, including but not limited to:</p>
			<ul>
				<li>Doing anything beyond the limits of what GradeFear or its provider can expect to handle, such as sending an inappropriate amount of requests</li>
				<li>Attempting to reverse-engineer, to bypass security measures</li>
				<li>Making financial profit out of GradeFear or GradeFear files</li>
				<li>Posting NSFW material, offensive names, illegal-, alcohol- or drug-related content, threats, homophoby, racism, sexism, and any form of discrimination</li>
			...
			<h2>Generalities</h2>
			<p>Your username and password are stored only for login purposes, such as storing your username and encrypted password, and for checking that you are logged in for some sensible operations. We encourage You to use an username that cannot is not linked to You, such as be using using the random username generator.</p>
			<p>Assuming a correct and normal use of GradeFear, like described above, GradeFear will store no other form of identification online, other than in conditions stated above, to ensure complete anonymity.</p>
			...
			<h2>Conclusion</h2>
			<p>We hope GradeFear helps You in your school progress, and wish You a lot of fun learning and improving!</p>
		</div>
		<br>
	</body>
</html>